#!/usr/bin/env python3
"""Serves the Supercombo Avatar Legends mirror, translating wiki URLs to local file paths."""
import os, sys
from http.server import ThreadingHTTPServer, SimpleHTTPRequestHandler
from urllib.parse import urlparse, unquote

LANDING_PAGE = '/w/Avatar_Legends'

TAB_FIX_CSS = b"""<style>
/* Override Tabber + wiki wrappers so all panels stack visibly.
...
print(f"Serving Supercombo Avatar Legends mirror on port {port}")
